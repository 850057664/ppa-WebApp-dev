...
class LoginComponent {
    ...
    submitForm() {
        ...
        if (this.cuntry_name_value == null || this.cuntry_name_value == "") {
            ...
            if (this.loginForm.value.userName == 'admin@genpact.com' && this.loginForm.value.password == '123456') {
                this.showUserAuthMessage = false;
                this.router.navigate(['/authentication/landing']);
            }
            else if (this.loginForm.value.userName == 'user@genpact.com' && this.loginForm.value.password == '123456') {
                this.router.navigate(['/authentication/landing']);
            }
            else if (this.loginForm.value.userName == 'client@genpact.com' && this.loginForm.value.password == '123456') {
                this.showUserAuthMessage = false;
                this.router.navigate(['/authentication/landing']);
            }
            else {
